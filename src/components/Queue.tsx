...
interface QueueProps {
  ...
  onAddTrack: (title: string, artist: string, url: string) => void;
...
export const Queue: React.FC<QueueProps> = ({
  ...
  const handleAddSong = (e: React.FormEvent) => {
    ...
    onAddTrack(songTitle, songArtist, songUrl);
    setSongTitle("");
    setSongArtist("");
    setSongUrl("");
          ...
          <DialogContent className="border border-black bg-white text-black p-6 rounded-none shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] max-w-md">
            ...
            <div className="space-y-6 pt-2">
              ...
              <div className="p-4 border border-dashed border-black bg-gray-50 text-center space-y-2">
                <p className="text-xs font-semibold uppercase">Upload MP3 File</p>
