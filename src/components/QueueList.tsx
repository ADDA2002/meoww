...
export function QueueList({
  ...
  return (
    <div className="border border-black bg-white p-4 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
        ...
        {queue.map((track, idx) => {
          ...
          return (
            ...
            >
              ...
              {/* Only show control buttons for host */}
              {isHost && (
      ...
      {/* Show notice for non-hosts */}
      {!isHost && (
        <div className="mt-3 pt-2 border-t border-gray-200 text-[10px] font-mono text-gray-400 text-center">
          Only host can manage queue
        </div>
      )}
    </div>
  );
